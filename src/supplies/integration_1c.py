...
class OneCIntegration:
    ...
    @staticmethod
    def find_or_create_supply_wild_item(supply_wild_orders: Dict, supply_id: str, wild_code: str) -> Dict[str, Any]:
        """
        Находит или создает элемент wild в структуре поставки.
        Args:
    ...
    async def process_account_orders(
        ...
        for order in filtered_orders:
            ...
            supply_item = self.find_or_create_supply_wild_item(
